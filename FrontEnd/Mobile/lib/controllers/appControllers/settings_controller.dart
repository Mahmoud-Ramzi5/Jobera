...
class SettingsController extends GetxController {
  ...
  Future<dynamic> getCountries() async {
    try {
      var response = await dio.get(
        'http://192.168.1.104:8000/api/countries',
        options: Options(
          headers: {
  ...
  Future<dynamic> getStates(String countryName) async {
    try {
      var response = await dio.post(
        'http://192.168.1.104:8000/api/states',
  ...
  Future<dynamic> getSkillTypes() async {
    try {
      var response = await dio.get(
        'http://192.168.1.104:8000/api/skills/types',
        options: Options(
          headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            'Accept': 'application/json',
  ...
  Future<dynamic> getSkills(String type) async {
    try {
      var response = await dio.get(
        'http://192.168.1.104:8000/api/skills?type[eq]=$type',
        options: Options(
          headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            'Accept': 'application/json',
  ...
  Future<dynamic> getAllSkills() async {
    try {
      var response = await dio.get(
        'http://192.168.1.104:8000/api/skills',
        options: Options(
          headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            'Accept': 'application/json',
  ...
  Future<dynamic> searchSkills(String name) async {
    try {
      var response = await dio.get(
        'http://192.168.1.104:8000/api/skills?name[like]=$name',
        options: Options(
          headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            'Accept': 'application/json',
  ...
  Future<dynamic> downloadFile(String fileName) async {
    try {
      final response = await dio.get(
        'http://192.168.1.104:8000/api/file/$fileName',
        options: Options(
