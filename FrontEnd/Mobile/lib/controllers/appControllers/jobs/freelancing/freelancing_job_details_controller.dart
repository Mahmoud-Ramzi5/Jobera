...
class FreelancingJobDetailsController extends GetxController {
  ...
  Future<dynamic> fetchFreelancingJob(int jobId) async {
    ...
    try {
      var response = await dio.get(
        'http://192.168.0.106:8000/api/FreelancingJobs/$jobId',
        options: Options(
          headers: {
  ...
  Future<dynamic> applyFreelancingJob(
    ...
    try {
      var response = await dio.post(
        'http://192.168.0.106:8000/api/FreelancingJob/apply',
        options: Options(
          headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            'Accept': 'application/json',
  ...
  Future<dynamic> endJob(
    ...
    try {
      var response = await dio.post(
        'http://192.168.0.106:8000/api/FreelancingJob/done/$defJobId',
        options: Options(
          headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            'Accept': 'application/json',
  ...
  Future<dynamic> changeOffer(
    ...
    try {
      var response = await dio.post(
        'http://192.168.0.106:8000/api/FreelancingJobs/offer',
        options: Options(
          headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            'Accept': 'application/json',
      ...
      confirm: OutlinedButton(
        onPressed: () async {
          try {
            String? token = sharedPreferences?.getString('access_token');
            var response = await dio.post(
              'http://192.168.0.106:8000/api/review',
              options: Options(
                headers: {
                  'Content-Type': 'application/json; charset=UTF-8',
                  'Accept': 'application/json',
