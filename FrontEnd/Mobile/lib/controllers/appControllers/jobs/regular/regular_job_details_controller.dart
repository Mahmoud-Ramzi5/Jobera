...
class RegularJobDetailsController extends GetxController {
  ...
  Future<dynamic> fetchRegularJob(int id) async {
    ...
    try {
      var response = await dio.get(
        'http://192.168.0.108:8000/api/regJobs/$id',
        options: Options(
          headers: {
  ...
  Future<dynamic> applyRegJob(int jobId, String comment) async {
    ...
    try {
      var response = await dio.post(
        'http://192.168.0.108:8000/api/regJob/apply',
        options: Options(
          headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            'Accept': 'application/json',
  ...
  Future<dynamic> deleteJob(int jobId) async {
    ...
    try {
      var response = await dio.delete(
        'http://192.168.0.108:8000/api/rggJobs/$jobId',
        options: Options(
          headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            'Accept': 'application/json',
  ...
  Future<dynamic> acceptUser(int competitorId, int defJobId) async {
    ...
    try {
      var response = await dio.post(
        'http://192.168.0.108:8000/api/regJob/accept/$defJobId',
        options: Options(
          headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            'Accept': 'application/json',
  ...
  Future<dynamic> createChat(int recieverId) async {
    ...
    try {
      var response = await dio.post(
        'http://192.168.0.108:8000/api/chats/create',
        options: Options(
          headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            'Accept': 'application/json',
