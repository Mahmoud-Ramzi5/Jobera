...
class EditPortfolioView extends StatelessWidget {
  final EditPortfolioController _editController =
      Get.find<EditPortfolioController>();
    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              GetBuilder<EditPortfolioController>(
                      ...
                      ProfilePhotoContainer(
                        ...
                        child: controller.hasImage
                            ? GestureDetector(
                                ...
                                child: CustomImage(
                                  path: controller.editPortfolio!.photo
                                      .toString(),
                                ),
                              )
                            : GestureDetector(
                                ...
                                child: controller.image == null
                                    ...
                                    : Image.memory(controller.displayImage),
                              ),
                      ),
                    ],
                  ),
              ...
              Padding(
                ...
                child: CustomTextField(
                  controller: _editController.editTitleController,
              ...
              Padding(
                padding: const EdgeInsets.all(10),
                child: CustomTextField(
                  controller: _editController.editDescriptionController,
                  textInputType: TextInputType.name,
                  obsecureText: false,
                    ...
                    Padding(
                      ...
                      child: SkillsContainer(
                        ...
                        widget: ListView.builder(
                          ...
                          itemCount: (controller.usedSkills.length / 2).ceil(),
                          shrinkWrap: true,
                          itemBuilder: (context, index) {
                            ...
                            return Row(
                              children: [
                                if (firstIndex < controller.usedSkills.length)
                                  Expanded(
                                    flex: 1,
                                    child: Padding(
                                      ...
                                      child: InputChip(
                                        ...
                                        label: BodyText(
                                          text: controller
                                              .usedSkills[firstIndex].name,
                                        ),
                                      ),
                                    ),
                                  ),
                                if (secondIndex < controller.usedSkills.length)
                                  Expanded(
                                    flex: 1,
                                    child: Padding(
                                      padding: const EdgeInsets.all(5),
                  ...
                  builder: (controller) => ListContainer(
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                          itemCount: controller.editPortfolio?.files!.length,
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
                          itemBuilder: (context, index) {
                            return Row(
