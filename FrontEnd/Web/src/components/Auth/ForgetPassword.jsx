    ...
    return (
        ...
        <div className={styles.screen}>
            ...
            {successMessage? (<>
                ...
                <form className={styles.ForgetPassword} onSubmit={handleSubmit}>
                    ...
                    <div className={styles.box1}>
                        <div className={styles.ForgetPassword__field}>
                        <i className={`${styles.user__icon} fas fa-user`}></i>
                        <input
                            type="email"
                            className={styles.ForgetPassword__input}
                            placeholder="Email"
                            value={email}
                            onChange={(event) => setEmail(event.target.value)}
                        />
                        </div>
                        <button type="submit" className={styles.ForgetPassword__submit}>
