...
const AdminJobs = () => {
  ...
  const columnStructure = {
    ...
    freelancing: [
      ...
      { key: "avg_salary", label: "Avreage Salary" },
      { key: "accepted_user", label: "Accepted User" },
    ],
  };
        ...
        <div>
          ...
          <div className={styles.slider}>
            <input
              ...
              name="jobType"
              value="fullTimeJob"
              checked={jobType === "fullTimeJob"}
              onChange={() => setJobType("fullTimeJob")}
            />
            <label htmlFor="fullTimeJob">FullTime</label>
            ...
            <input
              ...
              name="jobType"
              value="partTimeJob"
              checked={jobType === "partTimeJob"}
              onChange={() => setJobType("partTimeJob")}
            />
            <label htmlFor="partTimeJob">PartTime</label>
